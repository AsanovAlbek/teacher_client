...
class _$CourseImpl implements _Course {
  ...
  @override
  String toString() {
    return 'Course(id: $id, name: $name, description: $description, iconUrl: $iconUrl, rating: $rating, price: $price, status: $status, isTeacherCourse: $isTeacherCourse)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, name, description, iconUrl,
      rating, price, status, isTeacherCourse);
...
abstract class _Course implements Course {
  const factory _Course(
          ...
          @JsonKey(includeFromJson: false) final bool isTeacherCourse}) =
      _$CourseImpl;
